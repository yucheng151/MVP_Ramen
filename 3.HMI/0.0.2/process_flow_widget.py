...
class ProcessFlowWidget(tk.Frame):
    ...
    def set_state(self, process, mode: str, online: bool, selected_semi_step: int):
        changed = (
    ...
    def redraw(self):
        ...
        for step in NODE_ORDER:
            ...
            canvas.create_rectangle(
                ...
                fill=fill, outline=outline, width=3 if role == "selected" else 2,
