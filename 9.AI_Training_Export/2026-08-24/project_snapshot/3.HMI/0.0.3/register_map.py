...
# Full-auto order acknowledgement and completion status.
HMI_ORDER_UNIT_ID = 1020
HMI_ORDER_CABINET_NO = 1022
HMI_ORDER_FIRMNESS_NO = 1023
HMI_ORDER_INDEX = 1024
HMI_ORDER_VALID = 1025
PLC_ORDER_ACK_UNIT_ID = 1130
PLC_ORDER_ACK_INDEX = 1132
PLC_ORDER_FIFO_COUNT = 1133
PLC_ORDER_RESPONSE_CODE = 1134
PLC_ORDER_COMPLETE_UNIT_ID = 1135
PLC_ORDER_COMPLETE_INDEX = 1137

# Existing automatic-flow debug block. HMI reads this block only.
PLC_AUTO_DEBUG_START = 8000
PLC_AUTO_DEBUG_COUNT = 32

# Optional precise HMI monitor block. When D8100 equals AUTO_MONITOR_MAGIC,
# the HMI can show every bowl and basket UnitID without reconstructing events.
PLC_AUTO_MONITOR_START = 8100
PLC_AUTO_MONITOR_COUNT = 35
AUTO_MONITOR_MAGIC = 0xA55A
AUTO_MONITOR_VERSION = 1
