...
from ui_common import BasePage, BG, PANEL, PANEL_2, TEXT, MUTED, GREEN, RED, YELLOW, BLUE
...
class AutoSystemPage(BasePage):
    def __init__(self, parent, app):
        ...
        style.configure("Auto.TNotebook", background=BG, borderwidth=0)
        style.configure("Auto.TNotebook.Tab", font=("Microsoft JhengHei UI", 11, "bold"), padding=(18, 7))
        style.configure(
            "Auto.Treeview", background=PANEL, foreground=TEXT,
            fieldbackground=PANEL, rowheight=28, font=("Microsoft JhengHei UI", 10),
        )
        style.configure("Auto.Treeview.Heading", font=("Microsoft JhengHei UI", 10, "bold"))
    ...
    def _schedule_cabinet_render(self, _event=None):
        ...
        self._cabinet_render_job = self.after(60, self._render_cabinet_image)
    ...
    def _build_simulation(self):
        ...
        for row, (title, variable, values) in enumerate((
            ...
            ("軟硬度", self.sim_firmness_var, ("軟 1", "正常 2", "硬 3")),
        )):
