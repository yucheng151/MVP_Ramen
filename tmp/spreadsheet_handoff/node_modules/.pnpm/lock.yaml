  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.48.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.48.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.48.tgz':
    resolution: {integrity: sha512-pCvaIuh4lfQfsCu7okBFAGYPavmxLjSYc1OQLoYs0zyk00+hjnuKTEsYMdolxB62JB36oPe6tuRD8n7d9XriKQ==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.48.tgz}
    version: 2.8.48
    hasBin: true
    bundledDependencies:
      - '@oai/walnut'
